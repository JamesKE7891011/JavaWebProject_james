  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active text-light" aria-current="page" href="/JavaWebProject_james/frontend/Main.jsp">Main</a>
        </li>
        <li class="nav-item">
    ...
    <i class="bi bi-person-circle fs-3 me-4 text-light d-none d-lg-block"></i>
  </div>
</nav>
</body>
</html>